                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Price must be in decimal." ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtPrice" ValidationExpression="^\d{0,8}(\.\d{1,4}?$)">                          
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlCategories_SelectedIndexChanged" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="CategoryId" AppendDataBoundItems="True">
...
<asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger" CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Do you want to delete this product?');" CommandName="delete" CausesValidation="false" >
<i class="ti-trash"></i>
</asp:LinkButton>
</td>
</tr>
